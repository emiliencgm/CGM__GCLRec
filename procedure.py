...
class Train():
    ...
    def train(self, dataset, Recmodel, augmentation, epoch, optimizer, w=None):
        Recmodel = Recmodel
        Recmodel.train()
        ...
        for batch_i, train_data in enumerate(dataloader):
            ...
            if world.config['loss'] == 'BPR':
                ...
                #world.cprint('[FORWARD]')
                l_all = self.loss.bpr_contrast_loss(batch_users, batch_pos, batch_neg, aug_users1, aug_items1, aug_users2, aug_items2)
                ...
                l_all = self.loss.adaptive_softmax_loss(batch_users, batch_pos, batch_neg, aug_users1, aug_items1, aug_users2, aug_items2)
...
class Test():
    ...
    def test(self, dataset, Recmodel, precal, epoch, w=None, multicore=0):
