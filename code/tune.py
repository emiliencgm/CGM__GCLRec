...
cuda = 0
#for yelp2018
os.system(f'python main.py --model LightGCN --loss BPR_Contrast --augment SVD --init_method Normal --adaptive_method mlp --centroid_mode eigenvector --commonNeighbor_mode SC\
            ...
            --if_visual 0 --cuda {cuda} --comment tune_loss\
            --num_layers 2 --latent_dim_rec 32 --batch_size 1024')
