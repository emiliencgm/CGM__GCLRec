...
cuda = 0
#for yelp2018
os.system(f'python main.py --model LightGCN --loss Adaptive --augment No --init_method Normal --adaptive_method centroid --centroid_mode eigenvector --commonNeighbor_mode SC\
