...
if args.task == 'yelp2018':
    os.system(f'python main.py --alpha 0.5 --temp_tau_pop 0.1 --temp_tau 0.1 --notes tau1=tau2=0.1 --project {project} --name LightGCN+BC_loss --model LightGCN --loss BC --dataset {args.task} --init_method Normal --lr 0.001 --weight_decay 1e-4 --cuda {args.device} --num_layers 3 --latent_dim_rec 64 --batch_size 2048 --comment _ --if_valid {args.valid} --tag BC_loss --group baseline --job_type {args.task} --if_visual {args.visual} --visual_epoch 5')
