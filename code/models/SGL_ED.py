...
if args.task == 'yelp2018':
    os.system(f'python main.py --lambda1 0.1 --p_drop 0.1 --temp_tau 0.2 --notes _ --project {project} --name SGL_ED+BPR_CL --model SGL --loss BPR_Contrast --augment ED --dataset {args.task} --init_method Normal --lr 0.001 --weight_decay 1e-4 --cuda {args.device} --num_layers 3 --latent_dim_rec 64 --batch_size 2048 --comment _ --if_valid {args.valid} --tag SGL --group baseline --job_type {args.task} --if_visual {args.visual} --visual_epoch 1')
