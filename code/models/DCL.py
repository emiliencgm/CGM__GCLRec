...
if args.task == 'yelp2018':
    os.system(f'python main.py --tau_plus 0.1 --temp_tau 0.2 --notes temp_tau=0.2 --project {project} --name LightGCN+DCL --model LightGCN --loss DCL --dataset {args.task} --init_method Normal --lr 0.001 --weight_decay 1e-4 --cuda {args.device} --num_layers 3 --latent_dim_rec 64 --batch_size 2048 --comment _ --if_valid {args.valid} --tag DCL --group baseline --job_type {args.task} --if_visual {args.visual} --visual_epoch 2')
