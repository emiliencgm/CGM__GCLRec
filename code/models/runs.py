...
#[LightGCN + BPR] VS [LightGCN + Softmax]                                                        
# os.system('python main.py --dataset yelp2018 --model LightGCN --augment No --loss BPR --comment LightGCN+BPR')
# os.system('python main.py --dataset yelp2018 --model LightGCN --augment No --loss Softmax --comment LightGCN+Softmax')
