...
class CommonNeighbor():
    def __init__(self, dataset:dataset):
        ...
        #mat = self.CN_simi_unsymmetry_mat(mode = self.mode)
        mat_sp = self.CN_simi_unsymmetry_mat_sp(mode = self.mode)
        # print(mat.indices().shape)
        print('shape test :',mat_sp.indices().shape,'==',2*self.dataset.trainDataSize)
        # print(mat[0,31668],mat_sp[0,31668])
        # print(mat[0,31669],mat_sp[0,31669])
