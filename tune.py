...
cuda = 0
#for yelp2018
os.system(f'python main.py --model GCLRec --loss BPR_Contrast --augment Adaptive --init_method Normal --adaptive_method mlp --centroid_mode eigenvector --commonNeighbor_mode SC\
